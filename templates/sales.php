...
$bookings = getAllBookingsOfSales($month, $year);
...
<body>
    ...
    <div class="head-container">
        <div class="main-content" id="edit-booking">
            <div class="manage-head" id="sales">
                <h1>Doanh thu sales</h1>
            </div>
            <div class="icon-container">
                <a id="filter-icon" aria-haspopup="true" aria-expanded="false" onclick="toggleFilter()"><img src="../assets/icons/filter.svg"></a>
            </div>
            <form id="filter-section" class="filter-form" method="get" action="sales.php">
            ...
            <div class="grid-template">
                ...
                <div class="grid-item">
                    <h3>Thu nhập hoạt động sales</h3>
                    <h4 id="income_sales" data-tooltip="80% hoa hồng sales"></h4>
                </div>
            </div>    
